...
static lde_menu recover_help[] = { { CMD_CALL_MENU, "Popup menu of commands" },
...
static lde_menu ncmain_help[] = { { CMD_CALL_MENU, "Popup menu of commands" },
  { CMD_BLOCK_MODE, "Enter block mode." },
  { CMD_FLAG_ADJUST, "Menu of toggle flags" },
  { CMD_HELP, "Calls up this help" },
  { CMD_INODE_MODE, "Enter inode mode" },
...
static lde_menu recover_menu[] = { { CMD_BLOCK_MODE, "Block mode" },
  { CMD_HELP, "Help" },
...
static lde_menu ncmain_menu[] = { { CMD_BLOCK_MODE, "Block mode" },
  { CMD_HELP, "Help" },
  { CMD_INODE_MODE, "Inode mode" },
...
static lde_menu special_keys[] = { { KEY_BREAK, "BRK" },
  { KEY_DOWN, "DN" },
  { KEY_UP, "UP" },
  { KEY_LEFT, "LFT" },
  { KEY_RIGHT, "RGT" },
...
lde_keymap global_keymap[] = { { 'Q', CMD_EXIT_PROG },
  { 'q', CMD_EXIT },
...
static lde_keymap recover_keymap[] = { { 'r', CMD_DO_RECOVER },
  { 'R', CMD_DO_RECOVER },
  { 'u', CMD_CLR_RECOVER },
  { 'U', CMD_CLR_RECOVER },
  { 'n', REC_FILE_SIZE },
...
static lde_keymap main_keymap[] = { { 'q', CMD_EXIT_PROG }, { 0, 0 } };

static lde_keymap help_keymap[] = { { 0, 0 } };
